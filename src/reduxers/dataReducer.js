...
const dataReducer = (state = productList, action) => {
  ...
  switch (action.type) {
    case "ADD":
      return {
        ...state,
        product: [...state.product, action.payload.productBaru],
      };
    case "STOCK":
      return {
        ...state,
        product: [...state.product, action.payload.addStock],
      };
    case "DISKON":
      return {
        ...state,
        product: [...state.product, action.payload.diskonBaru],
      };
